...
namespace Problem08.DigitAsWord
{
    class DigitAsWord
    {
        static void Main()
        {
             ...
             */
            Console.Write("Enter a digit in the range [0..9]: ");// prompting the user to enter a digit
            string digit = Console.ReadLine();

            switch (digit)//use switch to check the entry and print the corresponding result
            {
